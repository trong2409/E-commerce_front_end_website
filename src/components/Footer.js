  ...
  return (
    <>
      ...
      <footer>
        <div className="container-xxl">
          <div className="row ">
            <div className="footerInfo col-12 col-md-6 col-xl-3 py-4">
              <h4 className="text-white mb-4">Contact Us</h4>
              <div>
                <address className="text-white fs-6">
                  203 Fake St. Mountain View, <br /> California, USA
                </address>
                <a
                ...
                <a
                  href="email@domain.com"
                  className="mt-2 d-block mb-0 text-white"
                >
                  email@domain.com
                </a>
                <div className="social_icons d-flex justify-content-center justify-content-xl-start gap-30 mt-4">
